  ...
  return (
    <>
      ...
      <div className="mb-32 flex flex-col text-center lg:max-w-5xl lg:text-left">
        ...
        социальных сетях по окончании игры.
        <br />
        <br />
        Единственное к чему обязывает вас наша Компания точно соблюдать время
        работы вашей точки. В настоящий момент услуга установки точки бесплатная
        подай заявку на подключение
